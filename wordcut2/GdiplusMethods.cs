...
namespace wordcut2
{
    public class GdiplusMethods
    {
        ...
        public static void MeasureDriverString(Graphics graphics, string text,
            Font font, Brush brush, PointF[] positions, ref RectangleF bounds, Matrix matrix)
        {
            if (graphics == null)
                throw new ArgumentNullException("graphics");
            if (text == null)
            ...
            int result = GdipMeasureDriverString(hGraphics, text, text.Length,
                hFont, positions, (int)DriverStringOptions.CmapLookup, hMatrix,ref bounds);
        }
         public static void MeasureDriverString(Graphics graphics, string text,
            Font font, Brush brush, PointF[] positions, ref RectangleF bounds)
         {
             MeasureDriverString(graphics, text,
            font, brush, positions, ref bounds,null);
         }
