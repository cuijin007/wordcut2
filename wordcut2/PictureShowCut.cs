...
//            {
//                positionsFrist[i] = new PointF(i * (this.wordLength/2 + this.wordInterval), wordHigh);
//            }
...
//}
    ...
    /// <summary>
        ...
        /// <param name="startX"></param>
        /// <param name="startY"></param>
        //public void CaculatePointf(string str, PointF[] pointSave,ref RectangleF bounds,float startX,float startY)
        //{
        //    pointSave = new PointF[str.Length];
        //    GdiplusMethods.MeasureDriverString(this.pictureBoxShow.CreateGraphics(), str, this.wordFont, Brushes.Black, pointSave, ref bounds);
        //    for (int i = 0; i < pointSave.Length; i++)
        //    {
        //        pointSave[i].X += startX;
        //        pointSave[i].Y += startY;
        //    }
        //    bounds.X = startX;
        //    bounds.Y = startY;
        //}